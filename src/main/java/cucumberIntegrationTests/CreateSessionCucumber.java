...
public class CreateSessionCucumber {
	...
	public static Properties lobConfigProp = new Properties();
	...
	public synchronized void androidDriver(String buildPath, Method methodName) throws MalformedURLException{
		...
		capabilities.setCapability("appPackage", "com.app.abhibus");
		capabilities.setCapability("appActivity", "com.abhibus.mobile.ABSplashActivity");
	...
	public void startAppiumServer(String os) throws ExecuteException, IOException, InterruptedException{
		if (os.contains("windows")){
			...
			command.addArgument("C:/Program Files/Appium/resources/app/node_modules/appium/build/lib/appium.js");
