...
@CucumberOptions(
        monochrome = true,
        features = "src/test/java/tests/cucumberTests/features/AbhiBus.feature",
...
public class CucumberRunnerUtil {
    ...
    public CreateSessionCucumber createSession = new CreateSessionCucumber();

    @BeforeSuite(alwaysRun = true)
    public void setCreateSession() throws Exception {
   // createSession.invokeAppium();
